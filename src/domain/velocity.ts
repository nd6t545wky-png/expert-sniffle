...
const BLOCKS: readonly BlockRange[] = [
  ...
  },
  {
    ...
    velocityDay: false,
    highEffortThrows: null,
    note: "GBL Term 4: Rounds 1 to 10, Friday and Sunday each week. There is no day in that week three clear days from a game, and the programme's own week plan says \"no separate velocity day\". Throwing hard here comes out of the games. The plyo work stays at hybrid B as patterning.",
  },
  {
    from: 22,
    to: 23,
